### Delete cross connection between ingress and egress ports ###
...
def del_connections(host, username, password, ports):
    """
    Delete cross-connections using single/multiple ports
    ...
    delete = CrossConnection(login)
    delete.removeConnection(ports)
    ses.logout()
...
if __name__ == '__main__':
    ...
    del_connections(args.host, args.username, args.password, args.ports)
